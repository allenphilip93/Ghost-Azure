# Ghost-Azure 
## What is different from the forked repo?
Most of the work is already done by Yannick and Radoslav, I've just modified the azuredeploy.json to support deployment on **32-bit Free Tier** for One-Click deploy to Azure
## Why Ghost-Azure?
